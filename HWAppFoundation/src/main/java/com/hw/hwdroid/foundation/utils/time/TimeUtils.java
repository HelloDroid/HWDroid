...
public class TimeUtils {
    ...
    public static String getCurrentDate(String format) {
        return timestamp2String(format, getCurrentTimestamp());
    }
     ...
     */
    public static boolean isBetween(String midDate, String startDate, String endDate) {
        boolean rt = false;
        try {
            if (!(isBefore(midDate, startDate)) && !isAfter(midDate, endDate)) {
                rt = true;
            }
        } catch (Exception e) {
        }
    ...
    public static int getWorkdates(String startDate, String endDate, Collection<String> holidays) {
        ...
        try {
            boolean asc = isBefore(startDate, endDate);
            ...
            for (; ; ) {
                ...
                if ((asc && isAfter(temp, endDate)) || (!asc && isBefore(temp, endDate))) {
                    return result;
                }
            }
        } catch (Exception e) {
    ...
    public static boolean isSameDay(long t) {
        ...
        if (!StringUtils.isNullOrWhiteSpace(srcString) && !StringUtils.isNullOrWhiteSpace(todayString)) {
            if (todayString.equals(srcString))
                return true;
        }
    ...
    public static boolean isSameYear(long t) {
        ...
        if (!StringUtils.isNullOrWhiteSpace(srcString) && !StringUtils.isNullOrWhiteSpace(thisYearString)) {
            if (thisYearString.equals(srcString))
                return true;
        }
    ...
    public static String formatMilliseconds(long milliseconds) {
        return formatMilliseconds(milliseconds, TIMEFORMAT_ALL);
    }
     ...
     * @return
     */
    public static String formatMilliseconds(long milliseconds, String dateFormat, Locale locale, TimeZone zone) {
        SimpleDateFormat sdf = null == locale ? new SimpleDateFormat(dateFormat)
     ...
     * @return
     */
    public static String getDayOfWeekFromStringResouce(Context context, int week) {
        String chineseWeek = "";
        switch (week) {
            case Calendar.SUNDAY:
                chineseWeek = context.getString(R.string.sunday);
                break;
            case Calendar.MONDAY:
                chineseWeek = context.getString(R.string.monday);
                break;
            case Calendar.TUESDAY:
                chineseWeek = context.getString(R.string.tuesday);
                break;
            case Calendar.WEDNESDAY:
                chineseWeek = context.getString(R.string.wednesday);
                break;
            case Calendar.THURSDAY:
                chineseWeek = context.getString(R.string.thursday);
                break;
            case Calendar.FRIDAY:
                chineseWeek = context.getString(R.string.friday);
                break;
            case Calendar.SATURDAY:
                chineseWeek = context.getString(R.string.saturday);
                break;
        }
     ...
     * @param context
     * @param time
     * @param showToday       如果是今天，显示今天
     * @param showYesterday   如果是昨天，显示昨天
     * @param showTheSameWeek 如果是同一周，显示周X
     * @return
     */
    public static String toCustomDateMD(Context context, long time, boolean showToday, boolean showYesterday, boolean showTheSameWeek) {
        if (null == context) {
        ...
        // 今年
            ...
            if (!showToday && !showYesterday && !showTheSameWeek) {
                return formatMilliseconds(time, TIMEFORMAT_MD);
            }
     ...
     * @return
     */
    public static String toCustomTime(Context context, long time, boolean showJust, boolean showBeforeTime, boolean showThisWeek, boolean
            accurateSeconds) {
        if (null == context) {
            return formatMilliseconds(time, TIMEFORMAT_MDHM);
        }
