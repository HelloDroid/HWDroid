...
public class ShotCutUtils {
     ...
     * @return
     */
    public static boolean hasShortCut11(@NonNull Context context, @StringRes int appNameResId) {
        Cursor cursor = null;
        try {
            String spermi;
            Uri uri = null;
     ...
     * @return
     */
    public static String getAuthorityFromPermission(@NonNull Context context, String permission) {
        if (permission == null)
            return null;
     ...
     * @param cx
     */
    public static void delShortcut(@NonNull Context cx) {
    ...
    public static void addShortcut(@NonNull Context context, @DrawableRes int iconResourceId, @StringRes int appId, Class target) {
        // delShortcut(context);
     ...
     * @param resourceId
     */
    private static void addShortcut(@NonNull Context cx, int resourceId) {
     ...
     */
    @SuppressWarnings("rawtypes")
    private static void addShortcut(@NonNull Context context, @DrawableRes int iconResourceId, @StringRes int appId, Class target, boolean many) {
        Intent addIntent = new Intent("com.android.launcher.action.INSTALL_SHORTCUT");
