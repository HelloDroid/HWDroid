...
public class PhoneNumUtils {
    ...
    public static boolean isCellphone4AreaCode(String cellphone) {
        String checkcellphone = "^[+,0-9]{0,4}(13[0-9]|15[0-9]|18[0-9]|17[0-9])[0-9]{8}$";
        return MatcherUtils.matches(checkcellphone, cellphone);
    }
    ...
    public static boolean isCellphone(String number) {
        return MatcherUtils.matches(REGEX_MOBILEPHONE, number);
    }
    ...
    public static boolean isFixedPhone(String number) {
        return MatcherUtils.matches(REGEX_FIXEDPHONE, number);
    }
