...
public class BSBeanUtils {
    ...
    public static Field getDeclaredField(Object object, String propertyName) throws NoSuchFieldException {
        if (object == null || StringUtils.isNullOrWhiteSpace(propertyName)) return null;
    ...
    public static Field getDeclaredField(Class clazz, String propertyName) throws NoSuchFieldException {
        if (clazz == null || StringUtils.isNullOrWhiteSpace(propertyName)) return null;
    ...
    public static void forceSetProperty(Object object, String propertyName, Object newValue) throws NoSuchFieldException {
        if (object == null || StringUtils.isNullOrWhiteSpace(propertyName)) return;
        Field field = getDeclaredField(object, propertyName);
        boolean accessible = field.isAccessible();
        field.setAccessible(true);
        try {
    ...
    public static Object invokePrivateMethod(Object object, String methodName, Object... params) throws NoSuchMethodException {
        if (object == null || StringUtils.isNullOrWhiteSpace(methodName)) return null;
    ...
    public static String getGetterName(Class type, String fieldName) {
        if (type == null || StringUtils.isNullOrWhiteSpace(fieldName)) return null;
