...
fun <V : View> View.bindView(@IdRes id: Int): ReadOnlyProperty<View, V> = required(id, viewFinder)
fun <V : View> Activity.bindView(@IdRes id: Int): ReadOnlyProperty<Activity, V> = required(id, viewFinder)
fun <V : View> Dialog.bindView(@IdRes id: Int): ReadOnlyProperty<Dialog, V> = required(id, viewFinder)
fun <V : View> DialogFragment.bindView(@IdRes id: Int): ReadOnlyProperty<DialogFragment, V> = required(id, viewFinder)
fun <V : View> SupportDialogFragment.bindView(@IdRes id: Int): ReadOnlyProperty<SupportDialogFragment, V> = required(id, viewFinder)
...
public fun <V : View> SupportDialogFragment.bindOptionalView(@IdRes id: Int): ReadOnlyProperty<SupportDialogFragment, V?> = optional(id, viewFinder)
...
private fun viewNotFound(@IdRes id: Int, desc: KProperty<*>): Nothing =
        throw IllegalStateException("View ID $id for '${desc.name}' not found.")

@Suppress("UNCHECKED_CAST")
private fun <T, V : View> required(@IdRes id: Int, finder: T.(Int) -> View?) = Lazy { t: T, desc -> t.finder(id) as V? ?: viewNotFound(id, desc) }

@Suppress("UNCHECKED_CAST")
private fun <T, V : View> optional(@IdRes id: Int, finder: T.(Int) -> View?) = Lazy { t: T, desc -> t.finder(id) as V? }
