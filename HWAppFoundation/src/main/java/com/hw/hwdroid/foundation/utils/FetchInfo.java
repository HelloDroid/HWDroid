...
public class FetchInfo {
    ...
    public static String getHWID(Context context, String localMacAddress) {
        if (null == localMacAddress || 0 == localMacAddress.length()) {
            return getCPUID() + "_" + SystemInfo.Instance().device;
        } else {
            return getCPUID() + "_" + SystemInfo.Instance().device + "_" + localMacAddress;
        }
    }
     ...
     * @return
     */
    public static String fetchTelStatus(Context cx) {
        String result = null;
