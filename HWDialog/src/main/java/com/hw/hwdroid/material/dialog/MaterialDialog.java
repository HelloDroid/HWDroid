...
import com.hw.hwdroid.material.dialog.internal.MDThemeSingleton;
import com.hw.hwdroid.material.dialog.util.DialogUtils;
import com.hw.hwdroid.material.dialog.util.RippleHelper;
import com.hw.hwdroid.material.dialog.util.TypefaceHelper;
...
public class MaterialDialog extends DialogBase implements View.OnClickListener, DefaultRvAdapter.InternalListCallback {
    ...
    public static class Builder {
        ...
        private void checkSingleton() {
            if (MDThemeSingleton.get(false) == null) {
                return;
            }
            MDThemeSingleton s = MDThemeSingleton.get();
            if (s.darkTheme) {
