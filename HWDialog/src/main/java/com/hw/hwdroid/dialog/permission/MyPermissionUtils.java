...
public class MyPermissionUtils {
    private static List<String> mGrantedPermissions = new ArrayList<>(5);
    private static List<String> mDeniedPermissions = new ArrayList<>(5);
    private static List<String> mUnShowedPermissions = new ArrayList<>(5);
    private static List<String> mNeedRequestPermissions = new ArrayList<>(5);
