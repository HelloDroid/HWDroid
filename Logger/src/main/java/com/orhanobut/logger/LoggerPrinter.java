...
final class LoggerPrinter implements Printer {
    ...
    public void json(String json) {
        ...
        try {
            ...
            if (json.startsWith("{")) {
                String message = new JSONObject(json).toString(JSON_INDENT);
                d(message);
                return;
            }

            if (json.startsWith("[")) {
                String message = new JSONArray(json).toString(JSON_INDENT);
                d(message);
                return;
            }
