 ...
 *******************************************************************************/
package common.android.pulltorefresh.library;
...
import common.android.pulltorefresh.library.internal.FlipLoadingLayout;
import common.android.pulltorefresh.library.internal.LoadingLayout;
import common.android.pulltorefresh.library.internal.RotateLoadingLayout;
import common.android.pulltorefresh.library.internal.Utils;
import common.android.pulltorefresh.library.internal.ViewCompat;

import common.android.pulltorefresh.R;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public final void performRefresh() {
        ...
        getHeaderLayout().setVisibility(View.VISIBLE);
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (USE_HW_LAYERS) {
            /**
             * Use a Hardware Layer on the Refreshable View if we've scrolled
             * at all. We don't use them on the Header/Footer Views as they
             * change often, which would negate any HW layer performance
             * boost.
             */
    ...
    public static enum AnimationStyle {
         ...
         * any drawable, which is automatically rotated and used as a Progress
         * Bar.
         */
        ROTATE,
