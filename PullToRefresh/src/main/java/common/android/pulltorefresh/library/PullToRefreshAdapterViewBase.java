...
import common.android.pulltorefresh.library.internal.EmptyViewMethodAccessor;
import common.android.pulltorefresh.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    /**
     * Gets whether an indicator graphic should be displayed when the View is
     * in a state where a Pull-to-Refresh can happen. An example of this state
     * is when the Adapter View is scrolled to the top and the mode is set to
    ...
    /**
     * Sets whether an indicator graphic should be displayed when the View is
     * in a state where a Pull-to-Refresh can happen. An example of this state
     * is when the Adapter View is scrolled to the top and the mode is set to
