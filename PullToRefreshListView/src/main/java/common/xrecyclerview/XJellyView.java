...
public class XJellyView extends View implements XBaseRefreshHeader {
    Path path;
    ...
    public XJellyView(Context context) {
        super(context);
        init();
    }

    public XJellyView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public XJellyView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public XJellyView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
