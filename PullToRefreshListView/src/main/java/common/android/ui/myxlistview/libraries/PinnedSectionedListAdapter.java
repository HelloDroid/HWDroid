/**
 * @(#)PinnedSectionedListAdapter.java 2014-3-6 Copyright 2014
 * All rights reserved.
 */
...
public abstract class PinnedSectionedListAdapter extends BaseAdapter implements IPinnedSectionedAdapter {
    ...
    /**
     * @see IPinnedSectionedAdapter#count()
     */
    @Override
    ...
    public void getCurrView(int section, int positionInSection, int position, View convertView, boolean isSectionView) {
    ...
    public final View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (isSectionHeader(position)) {
            View view = getSectionHeaderView(getSectionForPosition(position), convertView, parent);
            getCurrView(getSectionForPosition(position), -1, position, view, true);
            return view;
        }

        // List Item View
        View view = getItemView(getSectionForPosition(position), getPositionInSectionForPosition(position), convertView, parent);
        getCurrView(getSectionForPosition(position), getPositionInSectionForPosition(position), position, view, false);
        return view;
    }
